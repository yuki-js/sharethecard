/**
 * Hex utilities (controller-local)
 *
 * Moved from @remote-apdu/shared to keep the shared package environment-agnostic
 * and limited to code used across multiple modules.
 */
